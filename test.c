...
void test_all_algo(Instance* instance, int iteration_number)
{
    ...
    printf("Average cost after %d iterations: %d\n\n", iteration_number, all_cost / iteration_number);
    printf("Average evaluations for climber_first insertion: %d\n\n", eval / iteration_number);
    ...
    printf("Average cost after %d iterations: %d\n\n", iteration_number, all_cost / iteration_number);
    printf("Average evaluations for climber_first echange: %d\n\n", eval / iteration_number);
    ...
    printf("Average cost after %d iterations: %d\n\n", iteration_number, all_cost / iteration_number);
    printf("Average evaluations for climber_best insertion: %d\n\n", eval / iteration_number);
    ...
    printf("Average cost after %d iterations: %d\n\n", iteration_number, all_cost / iteration_number);
    printf("Average evaluations for climber_best echange: %d\n\n", eval / iteration_number);
    ...
    printf("Average cost after %d iterations: %d\n\n", iteration_number, all_cost / iteration_number);
    printf("Average evaluations for iterated_local_search insertion: %d\n\n", eval / iteration_number);
    ...
    printf("Average cost after %d iterations: %d\n\n", iteration_number, all_cost / iteration_number);
    printf("Average evaluations for iterated_local_search echange: %d\n\n", eval / iteration_number);
}